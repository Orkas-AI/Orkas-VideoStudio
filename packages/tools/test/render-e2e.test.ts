  ...
  beforeAll(async () => {
    ...
    writeFileSync(join(proj, 'composition-manifest.json'), JSON.stringify({
      ...
      art_direction: {
        ...
        cover: {
          scene_id: 'main-scene',
          headline: 'HyperFrames',
          content_signals: ['frame counter', 'render laboratory'],
          hero_visual: 'frame counter',
          composition_strategy: 'counter centered in a technical test chart',
          frame_time_sec: 0,
        },
